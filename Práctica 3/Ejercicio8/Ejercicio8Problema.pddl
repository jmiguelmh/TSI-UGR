(define (problem ejercicio8)
    ...
    (:init
        ...
        ; Se inicializa el coste de la solucion
        (= (costeTiempo) 0)

        ; Se define la distancia entre las localizaciones
        (= (distanciaEntreLocalizaciones) 20)

        ; Se define la velocidad de cada unidad
        ...
        ; Se define el tiempo que se tarda en reclutar cada unidad
        ...
        ; Se define el tiempo que se tarda en construir cada edificio
        (= (tiempoPorEntidad Barracones1) 50)
        (= (tiempoPorEntidad Extractor1) 20)

        ; Se define cuanto tiempo se tarda en recolectar
        (= (tiempoRecolectar) 5)
    ...
    (:goal
        (and
            ...
            ; El coste de la solucion debe ser menor a 484
            (< (costeTiempo) 484)
        )
    )
)